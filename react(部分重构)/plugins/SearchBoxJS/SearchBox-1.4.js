...
* */
function SearchBox(){
    this.host = "http://192.168.1.104:85";
    this.url = "";
    this.TabData = "";
    this.myMethod = null;
    this.rsCount = 0;
    ...
    this.go = function(method,id,valName,e,key,data){
        this.go2(method,id,valName,null,null,e, key,data);
    };

    //loca位置控件 method-方法   obj1-容器1   v1选字段1    obj2-容器2    v2选字段2 data-参数  key-关键字
    this.go2 = function(method,id,valName,id1,valName1,e,key,data){
        var obj = null, obj1 = null;
        if(id.indexOf!=undefined && id.indexOf("parent.")>-1 && e!=undefined && e!=null && e!=""){
            id = id.substring(7);
            obj =  $(e).parent().find("[aplDataName="+id+"]");
        //}else if(id.indexOf!=undefined && id.indexOf("[")>0) {
        ...
        if(id1!=undefined && id1!=null && id1!="") {           
            if (id1.indexOf!=undefined && id1.indexOf("parent.")>-1 && e!=undefined && e!=null && e!="") {
                id1 = id1.substring(7);
    ...
    this.show = function(resData){
        ...
        if(SearchBox.my.isShow == 0){
            ...
            SearchBox.my.layerIndex = window.layer.open({
                ...
                area: ['600px', '456px'],
                yes: function (i) {
                    SearchBox.my.boxData = null;
                    SearchBox.my.myMethod = null;
                    //alert(i);
                },
                content: strHtml
            });
        ...
        if(mothod == "users")
            ...
            SearchBox.my.cols = "c1,用户ID,70|c2,姓名,100";
        else if (mothod == "client")
            SearchBox.my.cols = "c1,客户编号,80|c2,客户名称,200";   
        else if (mothod == "coagent") //服务商
            SearchBox.my.cols = "c1,服务商编号,80|c2,服务商名称,200";   
        else if (mothod == "country") //国家
            SearchBox.my.cols = "c1,国家简码,80|c3,国家,200";        
        else if (mothod == "region") //分区表
            SearchBox.my.cols = "c1,渠道类型,80|c2,分区表名称,200";
        else if (mothod == "bankaccount") //银行账号
            SearchBox.my.cols = "c1,编号,80|c2,名称,200";
        else if (mothod == "summary") //科目管理
            SearchBox.my.cols = "c1,编号,80|c2,名称,200";
...
SearchBox.showData = function(i){
    //alert("showData SearchBox.my.boxData="+SearchBox.my.boxData);
    ...
    else if(SearchBox.my.boxData!=null){
        if(SearchBox.my.setObj != undefined)
            SearchBox.my.boxData[SearchBox.my.setObj] = v[SearchBox.my.valName];
        if(SearchBox.my.setObj1 != undefined)
            SearchBox.my.boxData[SearchBox.my.setObj1] = v[SearchBox.my.valName1];
        SearchBox.my.boxData=null;
    }
    else{
