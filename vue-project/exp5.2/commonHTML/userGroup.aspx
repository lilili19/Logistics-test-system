...
<body> 
	<div id="pagingSorting" style="display: none;">userGroup</div>
			...
			<div id="exp">
				...
				<div style="display: none;" id="boxInfo">
					    <form>						   
						    <p>						
							    <span>组名：</span>
							    <input type="text" :value="infoData.groupName" aplDataName="groupName" placeholder="输入1-20位" Verification="1-20">
						    </p>						   
					    </form>
				</div>
			</div>
