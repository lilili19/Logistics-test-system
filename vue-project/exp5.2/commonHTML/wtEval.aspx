...
<body> 
	<div id="pagingSorting" style="display: none;">wtEval</div>
			...
			<div id="exp">
				...
				<div style="display: none;" id="boxInfo">
					    <form>
						    <p>
							    <span>次序：</span>
							    <input type="text" :value="infoData.myIndex" aplDataName="myIndex" placeholder="输入限制1-10位" Verification="1-10">
						    </p>
						    <p>
							    <span>名称：</span>
							    <input type="text" :value="infoData.name" aplDataName="name" placeholder="输入限制1-20位" Verification="1-20">
						    </p>
						    <p>
							    <span>表达式：</span>
							    <input type="text" :value="infoData.eval" aplDataName="eval" placeholder="输入限制1-50位" Verification="1-50">
						    </p>						  
					    </form>
				</div>
			</div>
