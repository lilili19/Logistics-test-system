...
<body> 
	<div id="pagingSorting" style="display: none;">department</div>
			...
			<div id="exp">
				...
				<div style="display: none;" id="boxInfo">
					    <form>						   
						    ...
						    <p>
							    <span>部门名称：</span>
							    <input type="text" :value="infoData.deptName" aplDataName="deptName" placeholder="输入1-30位" Verification="1-30">
						    </p>						   			   				   
					    </form>
				</div>
			</div>
