			...
			<div id="exp">
				...
				<div style="display: none;" id="boxInfo">
					    <form>
						    <p>
							    <span>币制：</span>
							    <input type="text" :value="infoData.currencyName" aplDataName="currencyName" placeholder="输入限制1-20位" Verification="1-20">
						    </p>
						    <p>
							    <span>汇率：</span>
							    <input type="text" :value="infoData.hl" aplDataName="hl" placeholder="输入限制1-20位" Verification="1-20">
						    </p>						   
					    </form>
				</div>
